...
/* PC-98 NKEY コード表 (正典 = web/player/bridge.js PC98_KEYMAP。名前は headless 向けの短縮形)。
 * quubee_run --keys / MCP の quubee_key が名前で引く。 */
const NKEY = {
    RETURN: 0x1c, SPACE: 0x34, ESC: 0x00, CTRL: 0x74, SHIFT: 0x70,
    TAB: 0x0f, BS: 0x0e, CAPS: 0x71,
    A: 0x1d, B: 0x2d, C: 0x2b, D: 0x1f, E: 0x12, F: 0x20, G: 0x21, H: 0x22, I: 0x17,
    J: 0x23, K: 0x24, L: 0x25, M: 0x2f, N: 0x2e, O: 0x18, P: 0x19, Q: 0x10, R: 0x13,
    S: 0x1e, T: 0x14, U: 0x16, V: 0x2c, W: 0x11, X: 0x2a, Y: 0x15, Z: 0x29,
    D0: 0x0a, D1: 0x01, D2: 0x02, D3: 0x03, D4: 0x04,
    D5: 0x05, D6: 0x06, D7: 0x07, D8: 0x08, D9: 0x09,
    MINUS: 0x0b, COMMA: 0x30, PERIOD: 0x31, SLASH: 0x32,
    UP: 0x3a, LEFT: 0x3b, RIGHT: 0x3c, DOWN: 0x3d,
    INS: 0x38, DEL: 0x39, ROLLUP: 0x36, ROLLDOWN: 0x37, HOMECLR: 0x3e, HELP: 0x3f,
