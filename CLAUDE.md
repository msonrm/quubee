...
- 次: Phase 3 一区切り。残は Ray 完全表示 / 蟹味噌のテキスト面残留 / per-child env で argv[0] 正規化 (C1、いずれも Phase 4 候補)
...
- 次の候補: 快適化 (`np2cfg.multiple` 20→ 引き上げ、要 FM 再生負荷の再計測) / XMS・EMS HLE (640KB の壁) /
  Bio 100% の BEEP 超絶技巧 (oneshot 経路) / 互換性の長尾
